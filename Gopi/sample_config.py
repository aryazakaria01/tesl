...
class Config(object):
    ...
    API_ID = 16885568  # integer value, dont use ""
    API_HASH = "bd5a232cf132961aaac66da7d12b343c"
    ...
    SUPPORT_CHAT = 'gangs_for_udanpirappu'  #Your own group for support, do not add the @
    ...
    SPAMWATCH_SUPPORT_CHAT = "@gangs_for_udanpirappu"
