...
import Gopi.modules.sql.global_bans_sql as sql
from Gopi import (
    dispatcher,
    OWNER_ID,
    DEV_USERS,
...
from Gopi.modules.helper_funcs.alternate import typing_action, send_action
from Gopi.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
from Gopi.modules.sql.users_sql import get_all_chats
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        if user.reason:
            ...
            text += "\n\nAppeal at @Alexa_Help Or @AsadSupport if you think it's invalid."
    else:
        text = text.format("No")
    return text
