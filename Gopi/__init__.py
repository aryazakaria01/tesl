...
if ENV:
    ...
    FED_USERNAME = os.environ.get('FED_USERNAME', None)
    ...
    from Gopi.config import Development as Config
    TOKEN = Config.TOKEN
...
from Gopi.modules.helper_funcs.handlers import (CustomCommandHandler,
