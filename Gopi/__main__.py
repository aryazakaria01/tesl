...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="🦋 ᴏᴡɴᴇʀ 🦋", url="https://t.me/ROWDY_OF_PLUS"
        ),
        InlineKeyboardButton(
            text="🦋 ꜰᴇᴅ 🦋", url=f"https://t.me/{FED_USERNAME}"
        ),
    ],
    [
        InlineKeyboardButton(
...
""".format(
    ...
    "📝ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅꜱ ᴄᴀɴ ᴇɪᴛʜᴇʀ ʙᴇ ᴜꜱᴇᴅ ᴡɪᴛʜ / or !." if ALLOW_EXCL else "",
)
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module(f"Gopi.modules.{module_name}")
